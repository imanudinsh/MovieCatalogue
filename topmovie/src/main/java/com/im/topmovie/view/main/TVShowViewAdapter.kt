...
import com.im.topmovie.view.moviedetail.TVShowDetailActivity
import kotlinx.android.synthetic.main.item_row.view.*
import androidx.core.util.Pair as UtilPair

class TVShowViewAdapter(val activity: Activity) : androidx.recyclerview.widget.RecyclerView.Adapter<TVShowViewAdapter.CardViewViewHolder>() {
